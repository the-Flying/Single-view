...
def epipolar_geometric(Images_Path, K):
    ...
    parser.add_argument(
        '--match_threshold', type=float, default=0.001,
...
def main():
    ...
    # Images_Path = 'SubstitutionCalibration_Image7'
    # Images_Path = 'SubstitutionCalibration_Image9'  # patato
    # Images_Path = 'SubstitutionCalibration_Image11'  # apple
    # Images_Path = 'SubstitutionCalibration_Image12'  # blueberry
    # Images_Path = 'SubstitutionCalibration_Image13'  # cherry
    Images_Path = 'SubstitutionCalibration_Image3'  # B3
    # Images_Path = 'SubstitutionCalibration_Image6'  # B4
    ...
    # print(data1)
    # data1.to_csv('B4-42.csv', index=False)
    # data = pd.read_csv('B4-42.csv')
    # print(data)
    ...
    # fig.suptitle('', fontweight='bold', fontsize=12)
    ax = Axes3D(fig)
    fig.add_axes(ax)
    # ax.plot(Points3D[0], Points3D[1], Points3D[2], "red")
    ...
    plt.subplots_adjust(top=1, bottom=0, right=1, left=0, hspace=0, wspace=0)
    plt.margins(0, 0, 0)
    # plt.savefig('Reconstruction-B3.png', transparent=False, pad_inches=0.0, dpi=1000)
    plt.show()
